...
if opcion == 'Buscar vino':
    ...
    with st.form(key='nuevo_vino_form'):
        ...
        price = st.number_input('Precio', min_value=0.0, step=0.01, value=12.00)
        alcohol = st.number_input('Grado de alcohol', min_value=0.0, max_value=16.0, step=0.01, value=12.0)
